...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "kp", default_value="0.8", description="PID proportional gain"
            ),
            DeclareLaunchArgument(
                "ki", default_value="0.0", description="PID integral gain"
            ),
            DeclareLaunchArgument(
                "kd", default_value="0.1", description="PID derivative gain"
            ),
            DeclareLaunchArgument(
                ...
                parameters=[
                    {
                        ...
                        "brightness_threshold": LaunchConfiguration(
                            "brightness_threshold"
                        ),
                        ...
                        "curve_detection_method": "hough",
                        "use_bgr_filtering": True,
                        "separate_lanes": True,
                        "use_linear_regression": True,
                        "regression_min_points": 10,
                        "adaptive_lane_width": False,
                        "curve_prediction": False,
                        "min_lane_width": 200,
                        "max_lane_width": 500,
                    }
                ],
